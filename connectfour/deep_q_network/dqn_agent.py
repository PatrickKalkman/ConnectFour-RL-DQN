...
class DQNAgent:
    ...
    def train_step(self):
        ...
        # Update scheduler with average loss every 100 steps
        if self.training_steps % 100 == 0 and len(self.loss_window) > 0:
    ...
    def load(self, path):
        ...
        if "loss_window" in checkpoint:
            self.loss_window = checkpoint["loss_window"]
